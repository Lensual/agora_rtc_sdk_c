...
#pragma region agora::rtc
   ...
   */
  struct C_AudioVolumeInformation
  {
    /**
  ...
  //  */
  typedef void C_ILocalUserObserver;
#pragma region C_ILocalUserObserver
  // class ILocalUserObserver {
  //  public:
...
// };
#pragma endregion C_ILocalUserObserver

  typedef void C_IVideoFrameObserver2;
#pragma region C_IVideoFrameObserver2
