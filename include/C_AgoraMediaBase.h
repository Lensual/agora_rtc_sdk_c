#ifndef C_AGORA_MEDIA_BASE_H
#define C_AGORA_MEDIA_BASE_H
...
#ifndef C_OPTIONAL_ENUM_SIZE_T
#if __cplusplus >= 201103L || (defined(_MSC_VER) && _MSC_VER >= 1800)
#define C_OPTIONAL_ENUM_SIZE_T enum : size_t
#else
#define C_OPTIONAL_ENUM_SIZE_T enum
#endif
#endif
...
#pragma region agora::rtc
  ...
  typedef unsigned int C_uid_t;
  typedef unsigned int C_track_id_t;
  typedef unsigned int C_conn_id_t;
  typedef unsigned int C_video_track_id_t;

  static const unsigned int C_INVALID_TRACK_ID = 0xffffffff;
  static const unsigned int C_DEFAULT_CONNECTION_ID = 0;
  static const unsigned int C_DUMMY_CONNECTION_ID = UINT_MAX;

#define C_kAdmMaxDeviceNameSize 128
#define C_kAdmMaxGuidSize 128
   ...
   **/
  enum C_VIDEO_SOURCE_TYPE
  {
    /** Video captured by the camera.
     */
    VIDEO_SOURCE_CAMERA_PRIMARY = 0,
#ifdef __cplusplus
    VIDEO_SOURCE_CAMERA = C_VIDEO_SOURCE_TYPE::VIDEO_SOURCE_CAMERA_PRIMARY,
#else  // __cplusplus
...
#ifdef __cplusplus
    VIDEO_SOURCE_SCREEN = C_VIDEO_SOURCE_TYPE::VIDEO_SOURCE_SCREEN_PRIMARY,
#else  // __cplusplus
   ...
   */
  enum C_RAW_AUDIO_FRAME_OP_MODE_TYPE
  {
   ...
   */
  enum C_TRACK_AUDIO_MIXED_POLICY_TYPE
  {
 ...
 */
#define C_MAX_CONTENT_INSPECT_MODULE_COUNT 32
  enum C_CONTENT_INSPECT_RESULT
  {
...
#pragma region agora::media::base
   ...
   */
  enum C_CAMERA_VIDEO_SOURCE_TYPE
  {
    /**
  ...
  enum C_MEDIA_PLAYER_SOURCE_TYPE
  {
    /**
...
#pragma endregion agora::media::base
   ...
   */
  typedef void C_IAudioFrameObserverBase;
#pragma region C_IAudioFrameObserverBase
  /**
   * Audio frame types.
   */
  enum C_AUDIO_FRAME_TYPE
  {
    /**
     * 0: 16-bit PCM.
     */
  ...
  struct C_AudioFrame
  {
     ...
     */
    enum C_BYTES_PER_SAMPLE bytesPerSample;
    /**
...
#pragma endregion C_IAudioFrameObserverBase
   ...
   */
  typedef C_IAudioFrameObserverBase C_IAudioFrameObserver;
...
#pragma endregion C_IAudioFrameObserver
   ...
   */
  enum C_VIDEO_FRAME_PROCESS_MODE
  {
    /**
     * Read-only mode.
     *
   ...
   */
  enum C_EXTERNAL_VIDEO_SOURCE_TYPE
  {
    /**
   ...
   * @since v3.5.2
   */
  enum C_MediaRecorderContainerFormat
  {
    /**
     * 1: (Default) MP4.
     */
   ...
   * @since v3.5.2
   */
  enum C_MediaRecorderStreamType
  {
    /**
     * Only audio.
     */
     ...
     */
    STREAM_TYPE_BOTH = C_MediaRecorderStreamType::STREAM_TYPE_AUDIO | C_MediaRecorderStreamType::STREAM_TYPE_VIDEO,
#else  // __cplusplus
  /**
   * (Default) Audio and video.
   */
