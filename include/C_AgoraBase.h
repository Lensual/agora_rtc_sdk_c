#ifndef C_AGORA_BASE_H
#define C_AGORA_BASE_H

// for HACK for C++ agora::Optional
#define CONCAT(x, y) x##y
#define EXPAND(x, y) CONCAT(x, y)
#define RESERVED EXPAND(reserved, __LINE__)
// end for HACK for C++ agora::Optional
...
#pragma endregion agora::util
   ...
   */
  enum C_AUDIO_SESSION_OPERATION_RESTRICTION
  {
    /**
...
#pragma region agora::rtc
   ...
   */
  enum C_USER_OFFLINE_REASON_TYPE
  {
    /**
 ...
 * than the set value.
 */
#define C_COMPATIBLE_BITRATE -1

/**
 * -1: (For future use) The default minimum bitrate.
 */
#define C_DEFAULT_MIN_BITRATE -1

/**
 * -2: (For future use) Set minimum bitrate the same as target bitrate.
 */
#define C_DEFAULT_MIN_BITRATE_EQUAL_TO_TARGET_BITRATE -2

  /**
   * screen sharing supported capability level.
   */
  enum C_SCREEN_CAPTURE_FRAMERATE_CAPABILITY
  {
   ...
   */
  enum C_VIDEO_CODEC_CAPABILITY_LEVEL
  {
    /** No specified level */
   ...
   */
  struct C_EncodedAudioFrameAdvancedSettings
  {
    /**
   ...
   */
  struct C_EncodedAudioFrameInfo
  {
    /**
     * The audio codec: #AUDIO_CODEC_TYPE.
     */
    enum C_AUDIO_CODEC_TYPE codec;
    /**
     ...
     */
    struct C_EncodedAudioFrameAdvancedSettings advancedSettings;
  ...
  struct C_VideoSubscriptionOptions
  {
   ...
   */
  struct C_EncodedVideoFrameInfo
  {
     ...
     */
    enum C_VIDEO_FRAME_TYPE frameType;
    /**
     * The rotation information of the video frame: #VIDEO_ORIENTATION.
     */
    enum C_VIDEO_ORIENTATION rotation;
    /**
     ...
     */
    enum C_VIDEO_STREAM_TYPE streamType;
  };
   ...
   */
  struct C_AdvanceOptions
  {

    /**
     * The video encoder type preference..
     */
    enum C_ENCODING_PREFERENCE encodingPreference;

    /**
     * Video compression preference.
     */
    enum C_COMPRESSION_PREFERENCE compressionPreference;
  ...
  struct C_CodecCapLevels
  {
    enum C_VIDEO_CODEC_CAPABILITY_LEVEL hwDecodingLevel;
    enum C_VIDEO_CODEC_CAPABILITY_LEVEL swDecodingLevel;
  };
  ...
  struct C_CodecCapInfo
  {
    ...
    struct C_CodecCapLevels codecLevels;
  };
   ...
   */
  struct C_VideoEncoderConfiguration
  {
    /**
     ...
     */
    struct C_VideoDimensions dimensions;
    /**
     ...
     */
    enum C_ORIENTATION_MODE orientationMode;
    /**
     * The video degradation preference under limited bandwidth: #DEGRADATION_PREFERENCE.
     */
    enum C_DEGRADATION_PREFERENCE degradationPreference;
     ...
     */
    enum C_VIDEO_MIRROR_MODE_TYPE mirrorMode;

    /**
     * The advanced options for the video encoder configuration. See AdvanceOptions.
     */
    struct C_AdvanceOptions advanceOptions;
  ...
  void VideoEncoderConfiguration_Delete(struct C_VideoEncoderConfiguration *this_);

  /**
   * The configurations for the data stream.
   */
  struct C_DataStreamConfig
  {
    /**
   ...
   */
  struct C_SimulcastStreamConfig
  {
    /**
   ...
   */
  enum C_QUALITY_ADAPT_INDICATION
  {
    /**
   ...
   */
  enum C_AUDIENCE_LATENCY_LEVEL_TYPE
  {
    /**
     * 1: Low latency.
     */
   ...
   */
  enum C_EXPERIENCE_QUALITY_TYPE
  {
  ...
  //   // }
  // };
  // struct C_VideoFormat *C_VideoFormat_New();
  // void C_VideoFormat_Delete(struct C_VideoFormat *this_);

  /**
   * Video content hints.
   */
  enum C_VIDEO_CONTENT_HINT
  {
    /**
   ...
   */
  enum C_VIDEO_APPLICATION_SCENARIO_TYPE
  {
    /**
     * 0: Default Scenario.
     */
   ...
   */
  enum C_CAPTURE_BRIGHTNESS_LEVEL_TYPE
  {
  ...
  enum C_CAMERA_STABILIZATION_MODE
  {
     ...
     */
    CAMERA_STABILIZATION_MODE_MAX_LEVEL = C_CAMERA_STABILIZATION_MODE::CAMERA_STABILIZATION_MODE_LEVEL_3,
#else  // __cplusplus
  /** The maximum level of the camera stabilization mode.
   */
   ...
   * Local audio states.
   */
  enum C_LOCAL_AUDIO_STREAM_STATE
  {
    /**
   ...
   */
  enum C_LOCAL_AUDIO_STREAM_ERROR
  {
    /**
   ...
   */
  enum C_LOCAL_VIDEO_STREAM_STATE
  {
    /**
   ...
   */
  enum C_LOCAL_VIDEO_STREAM_ERROR
  {
    /**
   ...
   */
  enum C_REMOTE_AUDIO_STATE_REASON
  {
    /**
   ...
   */
  enum C_REMOTE_VIDEO_STATE_REASON
  {
    /**
     * 0: The SDK reports this reason when the video state changes.
     */
  ...
  struct C_VideoTrackInfo
  {
     ...
     */
    enum C_VIDEO_SOURCE_TYPE sourceType;
    /**
   ...
   */
  enum C_REMOTE_VIDEO_DOWNSCALE_LEVEL
  {
    /**
     * No downscale.
     */
   ...
   */
  enum C_VIDEO_CODEC_TYPE_FOR_STREAM
  {
    /**
     * 1: H.264.
     */
   ...
   */
  enum C_VIDEO_CODEC_PROFILE_TYPE
  {
    /**
   ...
   */
  enum C_AUDIO_CODEC_PROFILE_TYPE
  {
    /**
     * 0: LC-AAC.
     */
   ...
   */
  enum C_RTMP_STREAM_PUBLISH_STATE
  {
    /**
   ...
   */
  enum C_RTMP_STREAM_PUBLISH_ERROR_TYPE
  {
    /**
   ...
   */
  enum C_LASTMILE_PROBE_RESULT_STATE
  {
    /**
   ...
   */
  struct C_LastmileProbeOneWayResult
  {
    /**
   ...
   */
  enum C_CONNECTION_CHANGED_REASON_TYPE
  {
    /**
   ...
   */
  enum C_CLIENT_ROLE_CHANGE_FAILED_REASON
  {
    /**
  ...
  /** The contrast level.
   */
  enum C_LIGHTENING_CONTRAST_LEVEL
  {
    /** Low contrast level. */
   ...
   */
  enum C_LOW_LIGHT_ENHANCE_LEVEL
  {
    /**
   ...
   */
  enum C_VOICE_BEAUTIFIER_PRESET
  {
   ...
   */
  enum C_VOICE_CONVERSION_PRESET
  {
   ...
   */
  enum C_HEADPHONE_EQUALIZER_PRESET
  {
   ...
   */
  enum C_AUDIO_RECORDING_QUALITY_TYPE
  {
    /**
   ...
   */
  enum C_AUDIO_FILE_RECORDING_TYPE
  {
    /**
   ...
   */
  enum C_AUDIO_ENCODED_FRAME_OBSERVER_POSITION
  {
    /**
     * 1: Only records the audio of the local user.
     */
   ...
   */
  enum C_CHANNEL_MEDIA_RELAY_ERROR
  {
    /** 0: No error.
     */
    RELAY_OK = 0,
   ...
   */
  enum C_CHANNEL_MEDIA_RELAY_EVENT
  {
   ...
   */
  enum C_CHANNEL_MEDIA_RELAY_STATE
  {
   ...
   */
  enum C_MAX_USER_ACCOUNT_LENGTH_TYPE
  {
   ...
   */
  enum C_EAR_MONITORING_FILTER_TYPE
  {
    /**
   ...
   */
  struct C_VideoRenderingTracingInfo
  {
    /**
...
#pragma endregion agora
   ...
   */
  // void C_setAgoraLicenseCallback(agora::base::LicenseCallback *callback);
   ...
   */
  // C_LicenseCallback *C_getAgoraLicenseCallback();
